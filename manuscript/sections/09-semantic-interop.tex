...
\paragraph{Alignment learned from interaction.}
A third route needs neither a shared ontology nor a matcher.
Chocron and Schorlemmer let agents learn a vocabulary
alignment from the experience of interacting under a shared
protocol~\cite{chocron2020vocabulary}. The protocol
constrains which actions are allowed, and that constraint is
all the agents share. None of the surveyed protocols adopts
this route.
