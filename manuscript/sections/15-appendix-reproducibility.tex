...
Two answers deserve a caveat that a yes or no cannot carry.

On the data-set license: the companion repository will carry a permissive
license at publication, and the paper's claim is a commitment to that, not a
report of a released artifact. The three answers about licensing should be
read that way until the repository is public.
